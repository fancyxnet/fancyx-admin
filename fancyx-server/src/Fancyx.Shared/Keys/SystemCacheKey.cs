namespace Fancyx.Shared.Keys
{
    ...
    public class SystemCacheKey : CacheKeyBase
    {
        ...
        /// <returns></returns>
        public static string AccessToken(long userId, string sessionId) => $"access_token:{userId}:{sessionId}";
        ...
        /// <param name="sessionId">会话ID</param>
        /// <returns></returns>
        public static string RefreshToken(long userId, string sessionId) => $"refresh_token:{userId}:{sessionId}";
        ...
        /// <param name="userId">用户ID</param>
        /// <returns></returns>
        public static string UserPermission(long userId) => $"user_permission:{userId}";
        ...
        /// <param name="userId">用户ID</param>
        /// <returns></returns>
        public static string UserPermission(string userId) => $"user_permission:{userId}";
        ...
        /// <returns></returns>
        public static string UserSessionId(long userId) => $"user_session:{userId}";
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public static string UserDeptPower(long UserId) => $"user_dept_power:{UserId}";
    }
}