namespace Fancyx.Shared.Consts
{
    public static class LogRecordConsts
    {
        ...
        public const string DictAddContent = "新增字典{{Name}}";
        public const string DictDeleteSubType = "删除字典";
        public const string DictDeleteContent = "删除字典：名称：{{Name}}，类型：{{DictType}}";
        ...
        public const string DictDataUpdateContent = "编辑后：值={{Value}},启用={{IsEnabled}}";
        ...
        public const string ConfigUpdateContent = "编辑后：键={{Key}}，值={{Value}}，组={{GroupKey}}";
    }
}