namespace Fancyx.Core.Helpers
{
    public class MimeTypesHelper
    {
        ...
        private readonly Lazy<Dictionary<string, string>> _mimeTypeMap = new(() => new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        public string GetMimeType(string fileName)
        {
            ...
            if (_mimeTypeMap.Value.TryGetValue(ext, out string? result) && !string.IsNullOrWhiteSpace(result))
            {
                return result;
            }
        ...
        public void AddOrUpdate(string mime, string extension)
        {
            _mimeTypeMap.Value[extension] = mime;
        }

        public string Group(string mime)
        {
